    ...
    <div className="grid grid-rows-[auto_1fr_auto] min-h-screen bg-gradient-to-b from-blue-50 to-white dark:from-gray-900 dark:to-gray-800 font-[family-name:var(--font-geist-sans)]">
      ...
      <main className="flex flex-col items-center justify-center p-8 sm:p-16 text-center">
        <h2 className="text-4xl sm:text-5xl md:text-6xl font-bold mb-6">
          ...
          <span className="text-blue-600">ClassroomX</span>
        </h2>
        <p className="text-lg sm:text-xl max-w-2xl mb-10 text-gray-600 dark:text-gray-300">
          An innovative virtual classroom platform designed to enhance student
          engagement and make teaching more effective.
        </p>
        <div className="flex flex-col sm:flex-row gap-4 mb-16">
          ...
          <a
            href="#learn-more"
            className="rounded-full border border-gray-300 dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700 px-8 py-3 font-medium transition-colors"
          >
            Learn More
          </a>
        </div>
        ...
        >
          <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-sm hover:shadow-md transition-shadow justify-center flex flex-col items-center">
            ...
            <p className="text-gray-600 dark:text-gray-300">
              Engage students with interactive quizzes, polls, and digital
              whiteboards.
            </p>
          </div>
          ...
          <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-sm hover:shadow-md transition-shadow justify-center flex flex-col items-center">
            ...
            <p className="text-gray-600 dark:text-gray-300">
              Monitor student progress with advanced analytics and detailed
              reporting.
            </p>
          </div>
          ...
          <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-sm hover:shadow-md transition-shadow justify-center flex flex-col items-center">
            ...
            <p className="text-gray-600 dark:text-gray-300">
              Foster teamwork with group projects, shared documents, and
              breakout rooms.
            </p>
          </div>
        </div>
      ...
      {/* Footer */}
      <footer className="py-6 px-8 sm:px-16 border-t border-gray-200 dark:border-gray-700 text-center sm:text-left">
          ...
          <div className="flex gap-6">
            ...
            >
              ...
              <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
                <path
                  fillRule="evenodd"
                  d="M5.3 8.3h2.9v11.4H5.3V8.3zm1.4-4.5c.9 0 1.7.8 1.7 1.7s-.8 1.7-1.7 1.7-1.7-.8-1.7-1.7.8-1.7 1.7-1.7m3.5 4.5h2.8v1.3c.4-.8 1.4-1.5 2.8-1.5 3 0 3.6 2 3.6 4.5v7.1h-2.9v-6.3c0-1.2 0-2.6-1.6-2.6s-1.9 1.3-1.9 2.5v6.4h-2.9V8.3z"
                  clipRule="evenodd"
                />
              </svg>
            </a>
